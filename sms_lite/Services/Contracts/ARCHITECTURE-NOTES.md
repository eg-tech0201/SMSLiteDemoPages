...
## Current UI Surfaces
- `sms_lite/Screens/Surveys/SurveyDetails.razor`
  - survey detail
  - materials tab
  - survey records tab
- `sms_lite/Screens/Surveys/SurveyDocumentViewer.razor`
  - questionnaire/material viewer shell
- `sms_lite/Screens/Surveys/RespondentDetails.razor`
  - burden widget
  - interaction timeline
  - ELMA link shell
- `sms_lite/Screens/Search/GlobalSearch.razor`
  - grouped cross-system search
  - advanced filters
  - saved searches UI
- `sms_lite/Screens/Surveys/SurveyExports.razor`
